...
## Project Structure
    ...
    ├── sparkling_breeze_32912  # Django project configurations
...
1. Clone this repo and `cd sparkling_breeze_32912`
...
2. Clone this repo and `cd sparkling_breeze_32912`
